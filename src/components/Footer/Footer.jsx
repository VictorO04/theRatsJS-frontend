        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerMarca}>
            ...
            <div className={styles.fileiraSocial}>
              <a href="https://github.com/arthurmorais0227" target="_blank" rel="noopener noreferrer" className={styles.botaoSocial}>
                <FaGithub />
              </a>
          ...
          <div>
            ...
            <ul className={styles.listaLinks}>
              ...
              <li><span>Valinhos, São Paulo — Brasil</span></li>
            </ul>
            <div className={styles.botoesNav}>
              <button className={styles.botaoNav} onClick={() => navigate("/contato")}>
                {t.linkContato} →
              </button>
              <button className={styles.botaoNav} onClick={() => navigate("/sobre-nos")}>
                {t.linkSobre} →
              </button>
            </div>
          </div>
