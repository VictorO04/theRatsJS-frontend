...
export default function PaginaPrincipal() {
    ...
    const caracteristicasLiterarias =
        lang === 'en' ? livro.caracteristicasLiterarias_en : livro.caracteristicasLiterarias;
        ...
        <div className={styles.pagina}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroConteudo}>
                    <div className={styles.heroTop}>
                        <div className={styles.heroTexto}>
                            ...
                            <h1 className={styles.titulo}>
                                {titulo} — <span className={styles.destaque}>{autor}</span>
                            </h1>
                    ...
                    <div className={styles.enredoSection}>
                        <h2 className={styles.enredoTitle}>{lang === 'en' ? 'Plot' : 'Enredo'}</h2>
                        <p className={styles.enredoText}>{enredo}</p>
                    </div>

                    <div className={styles.heroDetails}>
                        <div className={styles.detailedInfoColumn}>
                            <div className={styles.detailedInfo}>
                                <span className={styles.detailedLabel}>
                                    {lang === 'en' ? 'Writing style' : 'Estilo de escrita'}
                                </span>
                                <p className={styles.detailedContent}>{estiloEscrita}</p>
                            </div>
                            <div className={styles.detailedInfo}>
                                <span className={styles.detailedLabel}>
                                    {lang === 'en' ? 'Reality' : 'Verossimilhança'}
                                </span>
                                <p className={styles.detailedContent}>{verossimilhanca}</p>
                            </div>
                            <div className={styles.detailedInfo}>
                                <span className={styles.detailedLabel}>
                                    {lang === 'en'
                        ...
                        <div className={styles.gridSecondary}>
                            ...
                            <div className={styles.sideColumn}>
                                <div className={styles.bloco}>
                                    <h2 className={styles.blocoTitulo}>
                                        {lang === 'en' ? 'Author notes' : 'Sobre o autor'}
                                    </h2>
                                    <p>{detalhesAutor}</p>
                                </div>
                                <div className={styles.blocoAlt}>
                                    <h2 className={styles.blocoTitulo}>
                                        {lang === 'en' ? 'Conclusion' : 'Conclusão'}
                                    </h2>
                                    <p>{conclusao}</p>
                                </div>
                            </div>
