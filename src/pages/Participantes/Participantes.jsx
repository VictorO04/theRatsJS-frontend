...
const texts = {
    'pt-br': {
        ...
        subtitulo:
            'Uma equipe de estudantes de Desenvolvimento de Sistemas que uniu código, literatura e inglês para criar uma plataforma bilíngue sobre a obra Os Ratos, de Dyonélio Machado.',
        integrantes: 'Integrantes',
        idioma: 'Idiomas',
        grandeObra: 'Grande obra',
        rotulo: 'Sobre o projeto',
        tituloSecao: 'Tecnologia a serviço da literatura',
        texto1: 'O TheRatsJS nasceu da integração entre a prática técnica de programação do SENAI e o domínio literário em Português e Inglês do SESI. O resultado é uma ferramenta colaborativa e bilíngue que prepara o estudante para o vestibular e para o mercado de trabalho.',
    ...
    en: {
        titulo: 'Who are we?',
        subtitulo:
            'A team of Systems Development students who brought together code, literature, and English to create a bilingual platform about the work The Rats, by Dyonélio Machado.',
        integrantes: 'Members',
        idioma: 'Languages',
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroConteudo}>
                    ...
                    <h1 className={styles.titulo}>
                        The Rats — <span className={styles.destaque}>{t.titulo}</span>
                    </h1>
                    <p className={styles.subtitulo}>{t.subtitulo}</p>
                    <div className={styles.stats}>
                        <div>
                            <span className={styles.statNumero}>
                                {carregando ? '—' : participantes.length}
                            </span>
                            <span className={styles.statRotulo}>{t.integrantes}</span>
                        </div>
                        <div>
                            <span className={styles.statNumero}>2</span>
                            <span className={styles.statRotulo}>{t.idioma}</span>
                        </div>
                        <div>
                            <span className={styles.statNumero}>1</span>
                            <span className={styles.statRotulo}>{t.grandeObra}</span>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className={styles.sobreGrid}>
                    ...
                    <div className={styles.sobreCards}>
                        <div className={styles.card}>
                            <div className={styles.cardFaixa} />
                ...
                <div className={styles.cabecalho}>
                    ...
                    {!carregando && !erro && (
                        <span className={styles.contador}>
                            {participantesFiltrados.length} {t.totalSecaoParticipantes}
                            {plural}
                        </span>
                    )}
                </div>
