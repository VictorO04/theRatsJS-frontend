...
const MATERIA_CONFIG = {
    Química: {
        icone: <FaFlask />,
        cor: '#e67e22',
        bordaCor: 'rgba(230,126,34,0.35)',
        bgCor: 'rgba(230,126,34,0.08)',
    },
    Matemática: {
        icone: <FaCalculator />,
        cor: '#3498db',
        bordaCor: 'rgba(52,152,219,0.35)',
        bgCor: 'rgba(52,152,219,0.08)',
    },
    Literatura: {
        icone: <FaBook />,
        cor: '#9b59b6',
        bordaCor: 'rgba(155,89,182,0.35)',
        bgCor: 'rgba(155,89,182,0.08)',
    },
    Geografia: {
        icone: <FaGlobe />,
        cor: '#27ae60',
        bordaCor: 'rgba(39,174,96,0.35)',
        bgCor: 'rgba(39,174,96,0.08)',
    },
    História: {
        icone: <FaLandmark />,
        cor: '#c0392b',
        bordaCor: 'rgba(192,57,43,0.35)',
        bgCor: 'rgba(192,57,43,0.08)',
    },
    Redação: {
        icone: <FaPenFancy />,
        cor: '#D46475',
        bordaCor: 'rgba(212,100,117,0.35)',
        bgCor: 'rgba(212,100,117,0.08)',
    },
    Física: {
        icone: <FaAtom />,
        cor: '#5B6BAF',
    ...
    Biologia: {
        icone: <FaDna />,
        cor: '#16a085',
        bordaCor: 'rgba(22,160,133,0.35)',
        bgCor: 'rgba(22,160,133,0.08)',
    },
    Inglês: {
        icone: <FaLanguage />,
        cor: '#2980b9',
        bordaCor: 'rgba(41,128,185,0.35)',
        bgCor: 'rgba(41,128,185,0.08)',
    },
    Português: {
        icone: <FaBook />,
        cor: '#8e44ad',
    ...
    return (
        <>
            ...
            <div className={styles.pagina}>
                ...
                <section
                    className={`${styles.cardsSection} ${simuladoSelecionado ? styles.withDetails : styles.noDetails}`}>
                    <div className={styles.cards}>
                        {carregando ? (
                            ...
                            simuladosFiltrados.map((simulado, indice) => {
                                ...
                                const ehSelecionado =
                                    simuladoSelecionado?.titulo === simulado.titulo;
                                return (
                                    <div
                                        key={indice}
                                        ...
                                        tabIndex={0}
                                        onKeyPress={(e) =>
                                            e.key === 'Enter' && setSimuladoSelecionado(simulado)
                                        }>
                                        <div
                                            className={styles.cardIcone}
                                            style={{
                                                color: configuracao.cor,
                                                background: configuracao.bgCor,
                                                border: `1px solid ${configuracao.bordaCor}`,
                                            }}>
                                            {configuracao.icone}
                                        </div>
                                        <h2 className={styles.cardTitulo}>{simulado.titulo}</h2>
                                        <p className={styles.cardQuestoes}>
                                ...
                                <div className={styles.detailsHeader}>
                                    <div>
                                        <p className={styles.detailsLabel}>
                                            {traducoes.detalhesTitulo}
                                        </p>
                                        <h2 className={styles.detailsTitle}>
                                            {simuladoSelecionado.titulo}
                                        </h2>
                                        <p className={styles.detailsInfo}>
                                            {simuladoSelecionado.quantidadeQuestoes} ·{' '}
                                            {simuladoSelecionado.nivel}
                                        </p>
                                    </div>
                                    <button
                                        className={styles.startButton}
                                        onClick={() =>
                                            navigate('/simulados/exame', {
                                                state: { simulado: simuladoSelecionado },
                                            })
                                        }
